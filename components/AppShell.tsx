...
const NAV: NavEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/stok/pengeluaran', label: 'Pengeluaran Stok', icon: ArrowUpFromLine },
      ...
      { href: '/stok/bins', label: 'Bin / Slot', icon: LayoutGrid },
    ],
  },
  {
...
const ROLE_PERMISSIONS: Record<string, string[] | '*'> = {
  ...
  SUPERVISOR: ['/dashboard', '/penerimaan', '/pembelian-po', '/produk',
    ...
    '/stok/saldo', '/stok/pengeluaran', '/stok/release', '/stok/kartu', '/stok/penyesuaian', '/stok/transfer', '/stok/bins'],
  ADMIN: ['/dashboard', '/penerimaan', '/pembelian-po', '/hutang', '/pengeluaran-pengadaan', '/produk',
          ...FP_ROUTES,
          ...KA_OPS_ROUTES,
          '/maintenance/permintaan', '/maintenance/jadwal', '/maintenance/aset', '/maintenance/laporan',
          '/stok/saldo', '/stok/pengeluaran', '/stok/release', '/stok/kartu', '/stok/penyesuaian', '/stok/transfer', '/stok/lokasi', '/stok/bins',
