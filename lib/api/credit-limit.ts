...
export async function sumOpenPiutang(db: Db, auth, pelangganId) {
...
export async function assertPelangganCredit(db: Db, auth, pelangganId, additionalAmount) {
...
export async function sumOpenHutang(db: Db, auth, supplierId) {
...
export async function assertSupplierCredit(db: Db, auth, supplierId, additionalAmount) {
