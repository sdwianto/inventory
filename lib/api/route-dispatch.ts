...
const HANDLER_LOADERS: Record<string, () => Promise<ApiHandler>> = {
  ...
  'people': async () => (await import('@/lib/api/handlers/people')).handlePeople,
  'kitchen-people': async () => (await import('@/lib/api/handlers/people')).handlePeople,
  'bank-txn': async () => (await import('@/lib/api/handlers/bank-txn')).handleBankTxn,
  'bank-imports': async () => (await import('@/lib/api/handlers/bank-txn')).handleBankTxn,
