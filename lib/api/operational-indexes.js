...
const INDEX_SPECS = [
  ...
  { collection: 'vendor_product_map', index: { tenantId: 1, vendorKode: 1 }, name: 'idx_vendor_map_tenant_kode' },
  { collection: 'vendor_product_map', index: { tenantId: 1, vendorTenantId: 1, vendorStokId: 1 }, name: 'uniq_vendor_map_stok', unique: true },
