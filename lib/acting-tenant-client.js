...
export function setActingTenantIdLocal(tenantId) {
  if (typeof window === 'undefined') return;
  try {
...
export async function syncActingTenantToServer(tenantId) {
...
export async function setActingTenantId(tenantId) {
