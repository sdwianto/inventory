...
describe('food-production enterprise gate', () => {
  ...
  it('menu-plan and RPN expose PDF acuan kerja dapur', () => {
    ...
    expect(menuPlan).toContain('includeRekap');
    expect(menuPlan).toContain('includeAcuanResep');
    expect(menuPlan).toContain('Rekap Total Bahan (gudang)');
    expect(menuPlan).toContain('Acuan resep');
    expect(menuPlan).toContain('!Array.isArray(row.lines)');
    expect(menuPlan).toContain('acuanOpen && acuanDoc');
    ...
    expect(plan).toContain('includeRekap');
    expect(plan).toContain('includeAcuanResep');
    expect(plan).toContain('Rekap Total Bahan (gudang)');
    expect(plan).toContain('Acuan resep');
    ...
    expect(doc).toContain('ACUAN RESEP PER 500 PORSI');
    expect(doc).toContain('includeRekap');
    expect(doc).toContain('includeAcuanResep');
