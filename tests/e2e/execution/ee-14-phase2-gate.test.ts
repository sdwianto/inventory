...
describe('EE-14 Phase 2 — Inventory registry consumer gate', () => {
  ...
  it('platform vendor package is 1.0.3 with events dependency', () => {
  ...
  it('ee13 registry gate documents platform 1.0.3 consumer path', () => {
    ...
    expect(gate).toContain("const PLATFORM_VERSION = '1.0.3'");
  });
});
